...
TOPICS = [
    {
        "folder": "17_overfitting_validation",
        "prefix": "overfitting_validation",
        "n": 33,
        "np": 34,
        "topic_ru": "переобучение и валидация",
        "meta_theory": "Занятие 33. Переобучение и валидация",
        "exercise_refs": [
            (1, "п. 1"),
            (2, "п. 4"),
            (3, "п. 10"),
    ...
    {
        "folder": "18_decision_tree",
        "prefix": "decision_tree",
        "n": 35,
        "np": 36,
        "topic_ru": "решающее дерево",
        "meta_theory": "Занятие 35. Решающее дерево",
        "exercise_refs": [
            (1, "п. 4"),
            (2, "п. 4"),
            (3, "п. 4"),
    ...
    {
        "folder": "19_bagging_random_forest",
        "prefix": "bagging_random_forest",
        "n": 37,
        "np": 38,
        "topic_ru": "bagging и случайный лес",
        "meta_theory": "Занятие 37. Bagging и случайный лес",
        "exercise_refs": [
            (1, "п. 3"),
            (2, "п. 7"),
            (3, "п. 5"),
    ...
    {
        "folder": "20_gradient_boosting",
        "prefix": "gradient_boosting",
        "n": 39,
        "np": 40,
        "topic_ru": "градиентный бустинг",
        "meta_theory": "Занятие 39. Градиентный бустинг",
        "exercise_refs": [
            (1, "п. 6"),
            (2, "п. 4"),
            (3, "п. 5"),
