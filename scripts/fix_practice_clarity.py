...
def main() -> None:
    patch_notebook(
        "13_workflow/workflow_practice.ipynb",
        {
            0: """
# Занятие 26. Практика: классификация иконок методом k ближайших соседей (kNN)
...
""",
    ...
    patch_notebook(
        "14_feature_engineering/feature_engineering_practice.ipynb",
        {
            5: """
---
## Задание 1. Split (~7 мин)

По мотивам занятия 25 о train/validation/test.
...
""",
    ...
    patch_notebook(
        "15_linear_regression/linear_regression_practice.ipynb",
        {
            0: """
...
""",
    ...
    patch_notebook(
        "16_logistic_regression/logistic_regression_practice.ipynb",
        {
            0: """
...
""",
    ...
    for path in [
        "17_overfitting_validation/overfitting_validation_practice.ipynb",
        "17_overfitting_validation/overfitting_validation_practice_solution.ipynb",
    ]:
        if (ROOT / path).exists():
            patch_notebook(
                path,
...
**Критерий:** напечатаны `test_score`, переведённый в положительный MSE, среднее и стандартное отклонение.
""",
                    15: """
---
...
""",
    ...
    for path in [
        "18_decision_tree/decision_tree_practice.ipynb",
        "18_decision_tree/decision_tree_practice_solution.ipynb",
    ]:
        if (ROOT / path).exists():
            patch_notebook(
                path,
...
""",
    ...
    for path in [
        "19_bagging_random_forest/bagging_random_forest_practice.ipynb",
        "19_bagging_random_forest/bagging_random_forest_practice_solution.ipynb",
    ]:
        if (ROOT / path).exists():
            patch_notebook(
                path,
...
**Критерий:** 2–3 предложения с опорой на train, validation и/или OOB.
""",
                },
            )

    patch_notebook(
        "20_gradient_boosting/gradient_boosting_practice.ipynb",
        {
            0: """
