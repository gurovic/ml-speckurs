...
Подставь `{topic}`, `{NN}` (номер папки), `{N}` (= NN×2−1), `{N+1}` (практика), пути к файлам и модель.
...
2. LESSON_OUTLINE.md: п. 1–N теории, 10–12 заданий практики с минутами, 12–15 упражнений; номера занятий: теория и упражнения — N, практика — N+1
...
Ссылка на практику: занятие N+1 (теория — N)
...
Заголовок: Занятие N+1 (если теория — N). Упражнения — тот же N; ссылки согласованы.
